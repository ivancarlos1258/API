...
namespace API.Domain.Models.Dto
{
    ...
    public class ClientePutValidator : AbstractValidator<ClientePutDto>
    {
        public ClientePutValidator()
        {
    ...
    public class ClientePutMapping : Profile
    {
        public ClientePutMapping() => CreateMap<ClientePutDto, Cliente>();
    }
}
